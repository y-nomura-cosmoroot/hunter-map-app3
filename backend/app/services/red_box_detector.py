...
class RedBoxDetector:
    ...
    def _detect_thick_red_borders(self, image: np.ndarray) -> List[np.ndarray]:
        ...
        for contour in contours:
            ...
            # Use higher threshold for main regions (5000 pixels²)
            # This filters out small noise and focuses on major red-boxed areas
            if area < 5000:
    ...
    def _detect_filled_red_areas(self, image: np.ndarray) -> List[np.ndarray]:
        ...
        for contour in contours:
            ...
            # Use higher threshold for filled areas (10000 pixels²)
            if area < 10000:
